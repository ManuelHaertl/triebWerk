...
void CEnvironmentCreator::CreateBackground()
{
    ...
    m_pBGPlane->m_Transform.AddChild(&m_pBGSnake->m_Transform);
    ...
    m_pBGPlane->m_Transform.AddChild(&m_pBGBassLeft->m_Transform);
    ...
    m_pBGPlane->m_Transform.AddChild(&m_pBGBassRight->m_Transform);
